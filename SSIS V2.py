...
def main():
    ...
    course.set("Select Course")
    course['values'] = (
    "BS in Computer Science", "BS in Computer Application", "BS in Information Technology", "BS in Information System")
    course.place(x=650, y=135)

    course_code = ttk.Combobox(root, width=25, font=("Lucida Console", 10))
    course_code.set("Select Course Code")
    course_code['values'] = ("BSCS", "BSCA", "BSIT", "BSIS")
    ...
    root_coursecode['values'] = ("BSCS", "BSCA", "BSIT", "BSIS")
